    ...
    <div class="card-body p-4">
      <div class="d-flex justify-content-between align-items-center">
        <div>
          ...
          <small class="text-muted">Lihat studio podcast dan live streaming yang cocok untuk Anda</small>
        </div>
      </div>
      <hr>
              ...
              <div class="card h-100 border-0 shadow-sm studio-card-custom">
                ...
                <div class="card-body p-4 d-flex flex-column justify-content-between">
                  ...
                  <div class="d-flex gap-2 mt-4">
                    <button type="button" class="btn btn-dark btn-sm flex-fill fw-semibold d-flex align-items-center justify-content-center gap-1 btn-preview" data-id="<?= $studio['id_studio'] ?>">
                      Lihat Detail
                    </button>
                  </div>
                </div>
        ...
        <div class="card border-0 shadow-sm">
          <div class="card-body text-center py-6">
            ...
            <p class="text-muted mb-4">
              Belum terdapat data studio yang tersimpan.
            </p>
          </div>
        </div>
